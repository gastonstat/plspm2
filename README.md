...
**Step 1)** In order to install `plspm2` you need to use the R package devtools. Run in your R console:
```ruby
# install "devtools"
...
**Step 2)** Then you need to install the packages `tester` and `turner`.
...
**Step 3)** And finally, you install `plspm2`. 
Run in your R console:
```ruby
# install "plspm2""
